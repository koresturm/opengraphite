...
import type { Opengraph } from "~/lib/type";
...
export const OpenGraphContext = createContext<OpenGraphContextType>({
    openGraphData: { type: "", title: "", description: "", url: "" },
    setOpenGraphData: () => { },
});
...
export const OpenGraphProvider = ({ children }: { children: React.ReactNode }) => {
    const [openGraphData, setOpenGraphData] = useState<Opengraph>({ type: "", title: "", description: "", url: "" });
